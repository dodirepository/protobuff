...
type ShopResponse struct {
	...
	Items    []*ShopItems `protobuf:"bytes,4,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *ShopResponse) GetShopId() int64 {
	if x != nil {
		return x.ShopId
	}
	return 0
...
func (x *ShopResponse) GetItems() []*ShopItems {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *ShopItems) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShopItems) ProtoMessage() {}

func (x *ShopItems) ProtoReflect() protoreflect.Message {
	mi := &file_shop_shop_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShopItems.ProtoReflect.Descriptor instead.
func (*ShopItems) Descriptor() ([]byte, []int) {
	return file_shop_shop_proto_rawDescGZIP(), []int{2}
}

func (x *ShopItems) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ShopItems) GetItemId() int64 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
func (x *ShopItems) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_shop_shop_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x73, 0x68, 0x6f, 0x70, 0x22, 0x84, 0x01, 0x0a, 0x0c, 0x53, 0x68, 0x6f, 0x70,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x73, 0x68, 0x6f, 0x70,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x17,
	...
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x73, 0x68, 0x6f, 0x70, 0x2e, 0x53, 0x68,
	0x6f, 0x70, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x26,
	0x0a, 0x0b, 0x53, 0x68, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a,
	0x07, 0x73, 0x68, 0x6f, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06,
	0x73, 0x68, 0x6f, 0x70, 0x49, 0x64, 0x22, 0x5c, 0x0a, 0x09, 0x53, 0x68, 0x6f, 0x70, 0x49, 0x74,
	...
	,
}
...
var file_shop_shop_proto_goTypes = []any{
	...
	(*ShopItems)(nil),    // 2: shop.ShopItems
}
var file_shop_shop_proto_depIdxs = []int32{
	2, // 0: shop.ShopResponse.items:type_name -> shop.ShopItems
